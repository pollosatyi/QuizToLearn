        ...
        public ListQA()
        {
            listQA = new List<(string, string)>()
            {
               ...
               ("19.Что делает hotfix finish","Завершает ветку hotfix\n"+
                ...
                ("98. Можно ли отменить это восстановление?","Если еще не закомичены:\n"+
                ...
                ("105.Когда удобно использовать git rm --cached?","Полезна в ситуациях когда нужно перестать отслеживать изменеия файлов\n"+

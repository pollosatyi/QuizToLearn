        ...
        public ListQA()
        {
            listQA = new List<(string, string)>()
            {
               ...
               ("19.Что делает hotfix finish","Завершает ветку hotfix\n"+
                ...
                ("863.Эндпоинт","метод вашего сервиса, представляемый для использования\n"+
                                "Выполняет конкретную задачу, принимает параметры и данные, возвращает данные\n"),
                ...
                ("893. Три вида паттернов CQRS","1. Regular \n"+
                                                "2. Progressive \n"+
                                                "3. Deluxe \n"),

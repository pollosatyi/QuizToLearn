        ...
        public ListQA()
        {
            listQA = new List<(string, string)>()
            {
               ...
               ("19.Что делает hotfix finish","Завершает ветку hotfix\n"+
                ...
                ("533.Хранитель или снимок. Паттерн","Поведенческий паттерн\n"+
                                            "Он позволяет определять, сохранять, а также востанавливать предыдущие состояния без нарушения инкапслуляции\n"
                                            ),

                ("534. Цепочка обязанностей. Паттерн  ","Поведенческий шаблон проектирования, который позволяет избежать жесткой привязки отправителя запроса к получателю\n"+
                ...
                ("535. Наблюдатель.(Издатель подписчик) Паттерн","Представляет поведенческий шаблон проектирования\n"+
                ...
                ("536. Команда. Паттерн","Позволяет инкапсулировать запрос на выполнение определенного действия в виде отдельного объекта\n"+
                ...
                ("537. Состояние паттерн","шаблон проектировани, который позволяет объекту изменять свое поведение\n "+

    ...
    internal class ListQA
    {
        ...
        public ListQA()
        {
            listQA = new List<(string, string)>()
            {
                ...
                ("17.Зачем нужна отдельная ветка релиза?","1. Изоляция релизных правок от разработки новых фич\n"+
                                                          "финальное тестирование и фиксирование багов,документы\n"+
                                                          "2.Возмножность работать параллельно:\n" +
                                                          "Одна команда занимается release,а другая develop\n"+
                                                          "3. Позволяет содержать только стабильные версии в master\n"),
                ...
                ("20.Что произойдёт, если hotfix содержит уникальные изменения?","merge в master и develop"),

                ("21.Почему нельзя фиксить баги прямо в master?","Чтобы гарантировать что master это продакшен\n"+
                                                                 "Фиксирование в master может превести появлению других багов\n"+
                                                                 "Нужно сохранять теги версий\n"+
                                                                 "Прямое фиксирование усложнит слияние текущего master с разработкой\n"),

                ("22.Чем отличается Git от GitHub?","Git это распределанная система контроля версий\n"+
                                                    "GitHub - веб платформа для хостинга Git репозиториев\n"),

                ("23.Может ли Git работать без GitHub?","Git — это децентрализованная система контроля версий,\n"+ 
                                                         "которая полностью функционирует локально.\n")
